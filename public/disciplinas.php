...
<head>
    <meta charset="UTF-8">
    <title>Adicionar ou Remover Itens</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">

<div class="container mt-5">
    <h1 class="text-center mb-4">Adicionar ou Remover Itens</h1>
        ...
        <div class="card-body">
            <form method="post" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="string" name="carga" value="<?= $editar['carga'] ?? '' ?>" class="form-control" required>
                </div>
        ...
        <div class="card-body">
            <table class="table table-striped align-middle">
                ...
                <?php if (empty($_SESSION['disciplinas'])): ?>
                    <tr><td colspan="4" class="text-muted">Nenhum item cadastrado.</td></tr>
                <?php else: ?>
    ...
    <div class="text-center mt-4">
        <a href="?reset=1" class="btn btn-outline-secondary">Limpar Itens</a>
    </div>
</div>
